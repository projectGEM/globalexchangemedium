#############################################################################
# Makefile for building: globalexchangemedium-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Dec 15 09:50:34 2017
# Project:  GlobalExchangeMedium-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile GlobalExchangeMedium-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/GlobalExchangeMedium/src/leveldb/libleveldb.a /tmp/GlobalExchangeMedium/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/share/qt4/mkspecs/common/unix.conf \
		...
		GlobalExchangeMedium-qt.pro
QMAKE_TARGET  = globalexchangemedium-qt
DESTDIR       = 
...
Makefile: GlobalExchangeMedium-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile GlobalExchangeMedium-qt.pro
...
/tmp/GlobalExchangeMedium/src/leveldb/libleveldb.a: FORCE
	cd /tmp/GlobalExchangeMedium/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/GlobalExchangeMedium/build/build.h: FORCE
	cd /tmp/GlobalExchangeMedium; /bin/sh share/genbuild.sh /tmp/GlobalExchangeMedium/build/build.h
